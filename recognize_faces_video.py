...
# loop over frames from the video file stream and we read the frame ,
# preprocess, and then detect face bounding boxes  + calculate encodings  for each bounding box.
while True:
    ...
    for ((top, right, bottom, left), name) in zip(boxes, names):
        ...
        cv2.putText(frame, name, (left, y), cv2.FONT_HERSHEY_SIMPLEX, .75, (0, 255, 0), 2)
